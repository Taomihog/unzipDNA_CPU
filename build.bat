...
echo Building...
REM executable
g++ -std=c++20 -fconstexpr-ops-limit=100000000000 main.cpp -DJ_SIZE=%LUT_SIZE% -DEXT_SIZE=%LUT_SIZE% -o main.exe
...
main.exe NEB_H5alpha_Accessory_colonization_factor_AcfD.txt out_NEB_H5alpha_Accessory_colonization_factor_AcfD.csv
